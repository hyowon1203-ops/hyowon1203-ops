...
- **AI 포토부스** *(팀 프로젝트)* — [GitHub](https://github.com/CHeeRiNG-CHiCKeN/interactive_photo_booth)
...
- **캠퍼스 실시간 흡연 감지 시스템** — [GitHub](https://github.com/hyowon1203-ops/osd)
  - 역할: OpenCV 및 YOLOv8을 활용한 상황 감지 로직 설계

### 📫 Contact
hyowon1203@gmail.com
